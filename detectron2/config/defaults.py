...
_C.MODEL.C3_ADAPTER = CN()
_C.MODEL.C3_ADAPTER.ENABLED = False
_C.MODEL.C3_ADAPTER.HIDDEN_DIM = 128
_C.MODEL.C3_ADAPTER.PERTURB_SCALE = 0.1
_C.MODEL.C3_ADAPTER.QUALITY_TAU = 0.5
_C.MODEL.C3_ADAPTER.QUALITY_LOGIT_TEMPERATURE = 1.0
_C.MODEL.C3_ADAPTER.SCATTER_MODE = "max"
_C.MODEL.C3_ADAPTER.CLAMP_QUALITY = True
_C.MODEL.C3_ADAPTER.FREEZE_BACKBONE = True
_C.MODEL.C3_ADAPTER.OBSERVE_PERIOD = 20
_C.MODEL.C3_ADAPTER.APPLY_RESIDUAL = True
_C.MODEL.C3_ADAPTER.C4_APPLY_RESIDUAL = False
_C.MODEL.C3_ADAPTER.C5_APPLY_RESIDUAL = False
_C.MODEL.C3_ADAPTER.RESIDUAL_SCALE = 1.0
_C.MODEL.C3_ADAPTER.C4_RESIDUAL_SCALE = 1.0
_C.MODEL.C3_ADAPTER.C5_RESIDUAL_SCALE = 1.0
_C.MODEL.C3_ADAPTER.SUPERVISED_PROJ_LOSS_WEIGHT = 0.0
_C.MODEL.C3_ADAPTER.SUPERVISED_PROJ_TEMPERATURE = 0.01
_C.MODEL.C3_ADAPTER.SUPERVISED_PROJ_USE_PROPOSALS = False
_C.MODEL.C3_ADAPTER.SUPERVISED_PROJ_FEATURE = "res3"
_C.MODEL.C3_ADAPTER.SUPERVISED_PROJ_ONLY = False
_C.MODEL.C3_ADAPTER.DETACH_QUALITY_MAP = False
_C.MODEL.C3_ADAPTER.FREEZE_QUALITY_PROJ = False
_C.MODEL.C3_ADAPTER.TRAIN_ADAPTER_ONLY = False
